...
private:
  ...
  std::pair<int, std::optional<torch::Tensor>> prefetch(const std::string &key,
                                                        bool with_lock = true);
  ...
  using save_request_queue_type = cyy::algorithm::thread_safe_linear_container<
  ...
  using fetch_request_queue_type = cyy::algorithm::thread_safe_linear_container<
